...
## 최상위 폴더
- `contracts` — contracts — 파일 1개, 하위 폴더 0개
- `media` — media — 파일 1개, 하위 폴더 0개

## 문서 텍스트 캐시 후보
- `media/photo.jpg` → `.jikji/doc_text/sha256_e11b9d9763dbcc461fc6aea37579d5b2319f9d56818586c2705c3f07d46e0f89.txt`

## 주요 검색 토큰
Format, JPEG, acme, acme-renewal.txt, answer, answer_pack_shell, contracts, jpg, media, pack, photo, photo.jpg, renewal, shell, txt
